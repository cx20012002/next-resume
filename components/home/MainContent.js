...
function MainContent() {
    return (
        <div className={`max-w-[1440px] w-full h-fit flex flex-col xl:gap-[80px] gap-[40px] items-center 
            ...
            {/* Introduce Section */}
            <ParallaxSection className={"w-full flex flex-col flex-none justify-start items-start xl:gap-10 gap-5 relative"}>
                {/* Title */}
                ...
                <div className={"flex flex-col md:flex-row xl:gap-[160px] lg:gap-[120px] gap-[40px] relative w-full"}>
                    ...
                    <div className={"flex flex-col flex-1 items-start xl:gap-10 gap-5"}>
                        ...
                        <div className={"flex flex-col xl:max-w-[480px] lg:w-full w-[80%] xl:h-[80px] h-[60px] " +
                            ...
                            <Link href={"/about"} className={`flex justify-between items-center w-full bg-black py-4 px-10 
            ...
            {/* Services */}
            <ParallaxSection className={"w-full flex flex-col justify-start items-start relative"}>
            ...
            <ParallaxSection className={"w-full flex flex-col relative"}>
                <MainContentHoverImage link={"/case-study/project-1"} image={images.serviceImage1}/>
            </ParallaxSection>
            <ParallaxSection className={"w-full flex flex-col relative overflow-hidden"}>
                <Slider/>
            </ParallaxSection>
            <ParallaxSection className={"w-full flex flex-col md:flex-row gap-10"}>
                <MainContentHoverImage link={"/case-study/project-1"} image={images.serviceImage2}/>
                <MainContentHoverImage link={"/case-study/project-1"} image={images.serviceImage3}/>
            </ParallaxSection>
            <ParallaxSection className={"w-full flex flex-col relative"}>
                <MainContentHoverImage link={"/case-study/project-1"} image={images.serviceImage4}/>
            </ParallaxSection>
        </div>
    )
}
